...
function weixin_robot_get_option_labels(){
    ...
    if($plugin_page == 'weixin-robot'){
    	$basic_section_fields = array(
			...
			'weixin_take_photo'				=> array('title'=>'启用拍照功能',		'type'=>'checkbox',	'description'=>'需要认证的公众号'),
	    );
...
function weixin_robot_basic_validate( $weixin_robot_basic ) {
	...
	if(isset($weixin_robot_basic['weixin_token'])){
		...
		$checkbox_keys = array('weixin_disable_stats','weixin_disable_search','weixin_take_photo','weixin_credit','weixin_advanced_api','weixin_3rd_search','weixin_share_notify');
